...
const SolvingCompontes = ({ selectedTickets, resolvetotal }) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 justify-items-center p-10 mt-5 mb-5">
      {/* In-Progress Card */}
      <div className="bg-gradient-to-r from-[#632ee3] to-[#9f62f2] text-white font-semibold p-10 rounded-lg w-[650px] h-[250px] text-center flex items-center justify-center shadow-lg mr-6">
        <div className="flex items-center justify-center gap-5">
          ...
          {/* Text */}
          <div className="text-center w-full h-ful">
      ...
      {/* Resolved Card */}
      <div className="bg-gradient-to-r from-[#54cf68] to-[#00827a] text-white font-semibold p-10 rounded-lg w-[650px] h-[250px] text-center flex items-center justify-center shadow-lg">
        <div className="flex items-center justify-center gap-5">
          {/* Left Image */}
          <div className="w-full h-full">
            <img src={bgimage} alt="vector1" className="w-[500px] h-[220px]" />
